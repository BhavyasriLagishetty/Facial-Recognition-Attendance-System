...
class Attendace:
    def __init__(self,root):
        ...
        img10 = img10.resize((800,200), Image.Resampling.LANCZOS)
        self.photoImg10 = ImageTk.PhotoImage(img10)
        bg_lbl=Label(self.root,image=self.photoImg10)
        bg_lbl.place(x=0,y=0,width=800,height=200)

        img11 = Image.open("college_images/AdobeStock_303989091.jpeg")
        img11 = img11.resize((800,200), Image.Resampling.LANCZOS)
        ...
        img30 = img30.resize((650,150), Image.Resampling.LANCZOS)
    ...
    def fetch_data(self):
        conn=mysql.connector.connect(host="localhost",username="root",password="Rolta@123",database="facial_recognition")
